...
import 'package:m3uxtream_player/features/jellyfin/widgets/jellyfin_series_episode_browser.dart';
...
class _JellyfinDetailsViewState extends ConsumerState<JellyfinDetailsView> {
  ...
  @override
  void didUpdateWidget(JellyfinDetailsView oldWidget) {
  ...
  String get _identity => '${widget.connection.credentialId}:${widget.item.id}';

  bool _isCurrentAction(int generation, String identity) =>
