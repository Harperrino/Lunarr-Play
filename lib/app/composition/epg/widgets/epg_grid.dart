...
import 'package:m3uxtream_player/app/composition/epg/widgets/epg_timeline_slot_lines.dart';
...
class _EpgGridState extends ConsumerState<EpgGrid> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(epgGridEntriesSnapshotProvider, (previous, next) {
                        ...
                        SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: Align(
                              ...
                              child: Text(
                                context.l10n.epgGridChannelHeader,
                                style: TextStyle(
                                  fontSize: 10,
...
class _EpgChannelCell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return EpgInteractiveSurface(
      ...
      semanticLabel: context.l10n.epgGridChannelSemantics(
        row.channel.name,
        epgGridRowSubtitle(row, now, context.l10n),
      ),
      ...
      child: Stack(
        ...
        children: [
          ...
          if (hasMatch && visiblePrograms.isNotEmpty)
            ...
            Center(
              child: Text(
                context.l10n.epgGridNoProgramme,
                style: TextStyle(
                  fontSize: 11,
                  color: Theme.of(context).colorScheme.onSurfaceVariant,
                ),
