...
class EpgProgramCell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final tooltipMessage =
        '${entry.title}\n'
        '${entry.startTime.hour.toString().padLeft(2, '0')}:'
        '${entry.startTime.minute.toString().padLeft(2, '0')}–'
        '${entry.endTime.hour.toString().padLeft(2, '0')}:'
        '${entry.endTime.minute.toString().padLeft(2, '0')}';
      ...
      child: Tooltip(
        ...
        child: EpgInteractiveSurface(
          ...
          semanticLabel: isLive
              ? context.l10n.epgProgramLiveSemantics(entry.title)
              : context.l10n.epgProgramSemantics(entry.title),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (layout.width > 70)
                    Text(
                      context.l10n.epgProgramDurationMinutes(
                        layout.durationMin,
                      ),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
