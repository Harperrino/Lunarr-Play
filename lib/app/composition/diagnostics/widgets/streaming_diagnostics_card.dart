...
class StreamingDiagnosticsCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return settingsAsync.when(
      ...
      error: (err, _) =>
          Text(context.l10n.diagnosticsSettingsLoadFailed('$err')),
      data: (settings) {
        ...
        return AppSurface(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          context.l10n.diagnosticsStreamingSubtitle,
                          style: TextStyle(
                            fontSize: 11,
                  ...
                  M3StatusPill(
                    label: settings.autoFallbackEnabled
                        ? context.l10n.diagnosticsFallbackOn
                        : context.l10n.diagnosticsFallbackOff,
              ...
              _ToggleRow(
                title: context.l10n.diagnosticsAutoFallbackTitle,
                subtitle: context.l10n.diagnosticsAutoFallbackSubtitle,
              ...
              _ToggleRow(
                title: context.l10n.diagnosticsShowOnErrorTitle,
                subtitle: context.l10n.diagnosticsShowOnErrorSubtitle,
              ...
              Wrap(
                ...
                children: [
                  _ActionButton(
                    ...
                    label: context.l10n.diagnosticsCopyLastFailure,
                    ...
                    onTap: lastFailure == null
                        ...
                        : () => _copyText(
                            ...
                            context.l10n.diagnosticsLastFailureCopied,
                          ),
                  ),
                  _ActionButton(
                    icon: Icons.description_rounded,
                    label: context.l10n.diagnosticsCopyPlayerLog,
                  ...
                  _ActionButton(
                    ...
                    label: context.l10n.diagnosticsTestStream,
  ...
  Future<void> _copyPlayerLogs(BuildContext context, WidgetRef ref) async {
    ...
    await _copyText(
      ...
      ref,
      playerLogs.join('\n'),
      context.l10n.diagnosticsPlayerLogCopied,
    );
  }
    ...
    try {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          appStatusSnackBar(
            context,
            message: context.l10n.diagnosticsStreamCheckFailed,
        ...
        children: [
          Row(
            children: [
              ...
              SizedBox(width: 8),
              Text(
                context.l10n.diagnosticsLastFailureTitle,
