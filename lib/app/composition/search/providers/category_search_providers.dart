    ...
    StreamProvider.autoDispose<Map<int, SearchEpgLine>>((ref) {
        ...
        for (final result in results)
          if (result.resolvedEpgChannelId != null)
            PlaylistEpgChannelKey(
              ...
              channelId: result.resolvedEpgChannelId!,
            ): result.channelId,
      };
      ...
      return ref
          ...
          .watchEntriesInRangeForPlaylistChannelIds(
            _groupSearchEpgKeys(resolvedIds.keys),
...
SearchEpgLine _lineForResult(
  ...
  Map<PlaylistEpgChannelKey, EpgEntry> currentByEpgId,
) {
  final resolvedId = result.resolvedEpgChannelId;
  final entry = resolvedId == null
      ? null
      : currentByEpgId[PlaylistEpgChannelKey(
          playlistId: result.playlistId,
...
Map<int, Set<String>> _groupSearchEpgKeys(
