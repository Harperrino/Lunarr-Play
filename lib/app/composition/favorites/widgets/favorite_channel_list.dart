...
class FavoriteChannelTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return M3MediaListItem(
      ...
      semanticLabel: context.l10n.favoriteChannelSemantics(channel.name),
      leading: Icon(
        Icons.favorite_rounded,
        color: colorScheme.tertiary,
        semanticLabel: context.l10n.favoriteIconSemantics,
      ),
        ...
        children: [
          ...
          M3LeadingSlot(
            child: Icon(
              ...
              semanticLabel: context.l10n.favoritePlayLiveSemantics,
            ),
          ),
        ],
      ),
