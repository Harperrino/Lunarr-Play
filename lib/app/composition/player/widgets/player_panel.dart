            ...
            children: [
              Row(
                children: [
                  Expanded(
                    child: Text(
                      headerViewModel.channelName ??
                          context.l10n.playerNoChannelSelected,
                      maxLines: 1,
                  ...
                  _StatusBadge(
                    label: !headerViewModel.hasSelectedChannel
                        ? context.l10n.playerStatusIdle
                        : headerViewModel.isLiveAudioStabilizing
                        ? context.l10n.playerStatusStabilizing
                        : headerViewModel.isLiveStartupBuffering
                        ? context.l10n.playerStatusWarmingUp
                        : headerViewModel.isBuffering
                        ? context.l10n.playerStatusBuffering
                        : headerViewModel.isPlaying
                        ? context.l10n.playerStatusLive
                        : context.l10n.playerStatusPaused,
              ...
              Text(
                context.l10n.playerExitFullscreenHint,
                style: TextStyle(
                  fontSize: 11,
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  context.l10n.playerLivePlaybackTitle,
          ...
          _StatusBadge(
            compact: compact,
            label: hasError
                ? context.l10n.playerStatusError
                : !viewModel.hasSelectedChannel
                ? context.l10n.playerStatusReady
                : viewModel.isLiveAudioStabilizing
                ? context.l10n.playerStatusStabilizing
                : viewModel.isBuffering
                ? context.l10n.playerStatusConnecting
                : viewModel.isPlaying
                ? context.l10n.playerStatusOnAir
                : context.l10n.playerStatusPaused,
            tone: hasError
  ...
  Widget _buildContent(BuildContext context) {
        ...
        children: [
          if (immersive)
            PlayerMessage(
              ...
              title: context.l10n.playerSelectChannelTitle,
              subtitle: context.l10n.playerSelectChannelFullscreenSubtitle,
    ...
    if (controller == null) {
      return PlayerMessage(
        ...
        title: context.l10n.playerPlaybackFailedTitle,
        subtitle:
