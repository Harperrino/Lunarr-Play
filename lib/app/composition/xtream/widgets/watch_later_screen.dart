...
import 'package:m3uxtream_player/app/composition/xtream/widgets/watch_later_button.dart';
    ...
    return AppSurface(
      ...
      child: asyncItems.when(
        ...
        error: (error, _) => _WatchLaterMessage(
          ...
          title: context.l10n.watchLaterLoadFailed,
          subtitle: error.toString(),
        ),
        data: (_) {
          if (selectedPlaylist == null) {
            return _WatchLaterMessage(
              icon: Icons.playlist_play_rounded,
              title: context.l10n.favoritesNoPlaylistTitle,
              subtitle: context.l10n.watchLaterNoPlaylistSubtitle,
            );
          }
          if (items.isEmpty) {
            return _WatchLaterMessage(
              icon: Icons.bookmark_border_rounded,
              title: context.l10n.watchLaterEmptyTitle,
              subtitle: context.l10n.watchLaterEmptySubtitle,
            );
          }
