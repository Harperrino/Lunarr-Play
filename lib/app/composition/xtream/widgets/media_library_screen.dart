...
import 'package:m3uxtream_player/app/composition/xtream/widgets/watch_later_screen.dart';
              ...
              child: TabBar(
                ...
                tabs: [
                  Tab(
                    ...
                    text: context.l10n.mediaLibraryMoviesTab,
                  ),
                  Tab(
                    icon: M3TabIconPair(
                      controller: _tabController,
                    ...
                    text: context.l10n.mediaLibrarySeriesTab,
                  ),
                  Tab(
                    icon: M3TabIconPair(
                      controller: _tabController,
                    ...
                    text: context.l10n.mediaLibraryWatchLaterTab,
                  ),
                ],
              ),
            ),
