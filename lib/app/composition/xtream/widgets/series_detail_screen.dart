    ...
    if (episodes.length == 1 && episodes.first.season == null) {
      ...
      return Center(
        child: FilledButton.icon(
          ...
          label: Text(context.l10n.seriesPlayEpisode(episode.title)),
        ),
      );
    }
            ...
            child: TabBar(
              ...
              tabs: [
                for (final season in seasons)
                  Tab(
                    text: season == 0
                        ? context.l10n.seriesEpisodesTab
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  context.l10n.seriesContinueWatching,
          ...
          FilledButton(
            ...
            child: Text(
              context.l10n.seriesContinueAction,
