                      ...
                      Expanded(
                        child: vodAsync.when(
                          ...
                          error: (err, _) => _VodEmptyState(
                            ...
                            title: context.l10n.vodLoadFailed,
                          ...
                          data: (_) {
                            if (selectedPlaylistId == null) {
                              return _VodEmptyState(
                                ...
                                subtitle:
                                    context.l10n.catalogNoPlaylistSubtitle,
                              );
                            }
                            if (movies.isEmpty) {
                              final searchActive =
                              ...
                              return _VodEmptyState(
                                icon: searchActive
                                    ...
                                    : Icons.movie_rounded,
                                title: searchActive
                                    ? context.l10n.vodNoSearchResults
                                    : filteredEmpty
                                    ? context.l10n.vodNoVisibleMovies
                                    : context.l10n.vodNoMoviesFound,
                                subtitle: searchActive
                                    ? context.l10n.vodClearSearchSubtitle
                                    : filteredEmpty
                                    ? context.l10n.vodHiddenByFiltersSubtitle
                                    : syncAsync.isLoading
                                    ? context.l10n.catalogSyncingPlaylist
                                    : context.l10n.vodSyncSubtitle,
                                actionLabel: filteredEmpty && localFiltersActive
                                    ...
                                    : searchActive ||
                                          ...
                                          filteredEmpty
                                    ? null
                                    : context.l10n.catalogSyncPlaylist,
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        if (onSync != null)
          TonalToolbarButton(
            label: context.l10n.catalogSyncAction,
