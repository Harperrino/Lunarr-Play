                            ...
                            if (seriesList.isEmpty) {
                              ...
                              return _SeriesEmptyState(
                                icon: searchActive
                                    ...
                                    : Icons.tv_rounded,
                                title: searchActive
                                    ? context.l10n.seriesNoSearchResults
                                    : filteredEmpty
                                    ? context.l10n.seriesNoVisibleSeries
                                    : context.l10n.seriesNoSeriesFound,
                                subtitle: searchActive
                                    ? context.l10n.seriesClearSearchSubtitle
                                    : filteredEmpty
                                    ? context.l10n.seriesHiddenByFiltersSubtitle
                                    : syncAsync.isLoading
                                    ? context.l10n.catalogSyncingPlaylist
                                    : context.l10n.seriesSyncSubtitle,
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        Text(
          context.l10n.seriesToolbarTitle,
